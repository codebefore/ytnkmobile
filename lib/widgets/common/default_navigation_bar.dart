      ...
      return StylishBottomBar(
        ...
        items: [
          BottomBarItem(
            ...
            title: Text(GlobalTexts.current.BOTTOM_NAVIGATION_BAR_profile),
            selectedColor: Colors.indigo,
            backgroundColor: Colors.indigo,
          ),
          BottomBarItem(
            icon: const Icon(Icons.dashboard_outlined),
            title: Text(GlobalTexts.current.BOTTOM_NAVIGATION_BAR_dashboard),
            selectedColor: Colors.indigo,
            backgroundColor: Colors.indigo,
          ),
          BottomBarItem(
            icon: const Icon(Icons.compare_arrows_sharp),
            title: Text(GlobalTexts.current.BOTTOM_NAVIGATION_BAR_matchings),
            selectedColor: Colors.indigo,
            backgroundColor: Colors.indigo,
